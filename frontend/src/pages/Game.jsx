  ...
  return (
    <div className="flex flex-col pt-10 gap-2 w-full">
      <div className="flex gap-2 w-full bg-gradient-to-l from-primary to-secondary/[0] py-4 rounded-2xl max-1200:flex-col">
        ...
        <div className="h-[284px] flex flex-col justify-between max-1200:h-auto">
          <p className="font-extrabold text-5xl w-full bg-gradient-to-r from-secondary to-secondary/[0] max-700:text-2xl">
            {game.name}
          </p>
